...
function Header()
{
//$this->Image('img/portadas/portada7.png',0,0,220,300);
//$this->Image('img/portadas/portada7.png',0,0,220,300);
//$this->Image('img/portadas/portada7.png',0,0,220,300);
$this->Image('img/portadas/portada3.jpg',0,0,220,300);
$this->Image('img/shinheky.png',160,15,25);
$this->SetY(4);
$this->SetX(143);

$this->SetFont('Arial','B',12);
$this->Cell(70, 4, 'REPORTE DE BAJAS',0,1);
$this->SetY(30);
$this->SetX(144);
$this->SetFont('Arial','',11);
$this->Cell(40, 25, utf8_decode('3º Escuadrón de la Muralla María'));
...
$this->Write(6,"Este es un ejemplo de texto que se aplica en PDF en Lib FPdf ");
$this->Write(6,"Este es un ejemplo de texto que se aplica en PDF en Lib FPdf ");
$this->Write(6,"Este es un ejemplo de texto que se aplica en PDF en Lib FPdf ");
$this->Write(6,"Este es un ejemplo de texto que se aplica en PDF en Lib FPdf ");
$this->Write(6,'www.fpdf.org','http://www.fpdf.org');
//$this->Text(50,70,"texto");
...
$pdf->Cell(80, 8, utf8_decode("Texto Onesimo \n Paulino"),'B',0,'C',1);
